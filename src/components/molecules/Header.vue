  ...
  <div class="flex justify-between gap-2 items-center">
    ...
    <div class="header-block__right flex gap-2 p-2 mr-2 items-center">
      <ComboboxRoot v-model="v" class="relative">
        <ComboboxAnchor :style="{ 'background-color': 'rgba(217, 217, 217, 0.2)' }" class="min-w-[160px] inline-flex items-center justify-between rounded px-[15px] text-[13px] leading-none h-[35px] gap-[5px] bg-white text-grass11 hover:shadow-[0_2px_10px] hover:shadow-black/10 focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-grass9 outline-none">
          <i class="fa-solid fa-magnifying-glass"></i>
          <ComboboxInput class="!bg-transparent outline-none text-grass11 h-full selection:bg-grass5 placeholder-mauve8" placeholder="Search..." />
        </ComboboxAnchor>

        <ComboboxContent :style="{width: '195px'}" class="absolute z-10 w-30 mt-2 min-w-[160px] bg-white overflow-hidden rounded shadow-[0px_10px_38px_-10px_rgba(22,_23,_24,_0.35),_0px_10px_20px_-15px_rgba(22,_23,_24,_0.2)] will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade data-[side=right]:animate-slideLeftAndFade data-[side=bottom]:animate-slideUpAndFade data-[side=left]:animate-slideRightAndFade">
